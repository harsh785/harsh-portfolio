...
const lines = [
  { text: "$ ssh harsh@cloud.devops.io", delay: 0, color: "#00d4ff" },
  ...
  { text: "$ whoami", delay: 1800, color: "#00d4ff" },
  { text: "harsh_dixit -- Senior Cloud & DevOps Engineer", delay: 2200, color: "#e2e8f0" },
  { text: "", delay: 2500, color: "" },
  { text: "$ cat certifications.txt", delay: 2700, color: "#00d4ff" },
  { text: "[✓] AWS Solutions Architect Associate (SAA-C03)", delay: 3100, color: "#FF9900" },
  { text: "", delay: 3400, color: "" },
  { text: "$ ls -la experience/", delay: 3600, color: "#00d4ff" },
  { text: "drwxr-xr-x  caylent/         Senior Cloud Engineer    [CURRENT]", delay: 4000, color: "#7c3aed" },
  ...
  { text: "$ ./load_portfolio.sh", delay: 5000, color: "#00d4ff" },
    ...
    <AnimatePresence>
      {!done && (
        <motion.div
          ...
          className="fixed inset-0 z-[100] bg-[#0a0a0f] flex items-center justify-center p-8"
        >
          <div className="w-full max-w-2xl">
            {/* Terminal window chrome */}
            <div className="bg-[#1a1a2e] rounded-t-xl border border-[#00d4ff]/10 px-4 py-3 flex items-center gap-2">
              <div className="w-3 h-3 rounded-full bg-[#ff5f57]" />
              <div className="w-3 h-3 rounded-full bg-[#ffbd2e]" />
              <div className="w-3 h-3 rounded-full bg-[#28c840]" />
              <span className="ml-2 text-slate-500 text-xs font-mono">bash — 80×24</span>
            </div>
            <div className="bg-[#0d0d1a] rounded-b-xl border border-t-0 border-[#00d4ff]/10 p-6 min-h-[320px] font-mono text-sm">
              {lines.map((line, i) => (
